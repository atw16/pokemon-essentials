  ...
  def drawPageFive
   ...
   overlay.clear
    ...
    textpos = [
       ...
       [sprintf("%d",@pokemon.ev[4]),evColumn,186,2,Color.new(64,64,64),Color.new(176,176,176)],
       [sprintf("%d",@pokemon.iv[4]),ivColumn,186,2,Color.new(64,64,64),Color.new(176,176,176)],
       [_INTL("Sp. Def"),textColumn,218,2,base,statshadows[4]],
       [sprintf("%d",@pokemon.ev[5]),evColumn,218,2,Color.new(64,64,64),Color.new(176,176,176)],
       [sprintf("%d",@pokemon.iv[5]),ivColumn,218,2,Color.new(64,64,64),Color.new(176,176,176)],
	     [_INTL("Speed"),textColumn,250,2,base,statshadows[2]],
       [sprintf("%d",@pokemon.ev[3]),evColumn,250,2,Color.new(64,64,64),Color.new(176,176,176)],
       [sprintf("%d",@pokemon.iv[3]),ivColumn,250,2,Color.new(64,64,64),Color.new(176,176,176)],
       [_INTL("Ability"),224,284,0,base,shadow],
       [PBAbilities.getName(@pokemon.ability),362,284,0,Color.new(64,64,64),Color.new(176,176,176)],
    ]
    if @pokemon.hasItem?
